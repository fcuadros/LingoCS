...
{
    public partial class FrmListadoCostoEmbalaje : Form
    {
        ...
        public FrmListadoCostoEmbalaje()
        {
            InitializeComponent();
        }

        private void FrmListadoCostoEmbalaje_Load(object sender, EventArgs e)
        {
            CargarListado();
        }
        ...
        private void FrmListadoCostoEmbalaje_Activated(object sender, EventArgs e)
        {
            Refrescar();
        }
    }
