...
{
    public partial class FrmListadoCostoAlmacenamiento : Form
    {
        ...
        public FrmListadoCostoAlmacenamiento()
        {
            InitializeComponent();
        }

        private void FrmListadoCostoAlmacenamiento_Load(object sender, EventArgs e)
        {
            CargarListado();
        }
        ...
        private void FrmListadoCostoAlmacenamiento_Activated(object sender, EventArgs e)
        {
            Refrescar();
        }
    }
