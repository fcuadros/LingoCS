...
{
    public partial class FrmListadoCapacidadPlanta : Form
    {
        ...
        public FrmListadoCapacidadPlanta()
        {
            InitializeComponent();
        }

        private void FrmListadoCapacidadPlanta_Load(object sender, EventArgs e)
        {
            CargarListado();
        }
        ...
        private void FrmListadoCapacidadPlanta_Activated(object sender, EventArgs e)
        {
            Refrescar();
        }
    }
